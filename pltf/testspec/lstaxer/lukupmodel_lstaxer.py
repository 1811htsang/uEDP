...
# NOTE - Phân tách các chuỗi cục bộ rồi thực hiện ghép lại từng phần cho tới khi hoàn chỉnh model 
...
[StreamStartEvent(),
 ...
 # REVIEW - entry of tnorms must map to sequence structure tsm_resrc -> fsm_resrc -> id_symbol -> queue_name -> handler -> hex_val
 MappingStartEvent(anchor='tnorm1-ctrl', tag=None, implicit=True),
 # REVIEW - tsm_resc must map to sequence structure states -> state_trans -> object -> table
 ...
 MappingStartEvent(anchor=None, tag=None, implicit=True),
 # REVIEW - fsm_resrc must map to sequence structure states -> object
 ScalarEvent(anchor=None, tag=None, implicit=(True, False), value='states'),
 SequenceStartEvent(anchor=None, tag=None, implicit=True),
 ...
 # REVIEW - entry of tpolls must map to sequence structure id_symbol -> handler -> hex_val
 ScalarEvent(anchor=None, tag=None, implicit=(True, False), value='id_symbol'),
 ...
 # REVIEW - entry of sigs must map to sequence structure id_symbol -> hex_val
 ScalarEvent(anchor=None, tag=None, implicit=(True, False), value='id_symbol'),
 ...
 # REVIEW - entry of glbda must map to sequence structure name -> type -> initial_value
 ...
 SequenceStartEvent(anchor=None, tag=None, implicit=True),
 MappingStartEvent(anchor=None, tag=None, implicit=True),
 # REVIEW - entry of tsm-item must map to sequence structure id -> trans -> on-ntry -> on-actv -> on-exit
 ...
 SequenceStartEvent(anchor=None, tag=None, implicit=True),
 # REVIEW - entry of trans must map to single trans-obj or list of trans-obj
 MappingStartEvent(anchor=None, tag=None, implicit=True),
 # REVIEW - entry of trans-obj must map to sequence structure sig -> goto
 ...
 # REVIEW - on-ntry must map to single actv-obj or list of actv-obj = steps
 MappingStartEvent(anchor=None, tag=None, implicit=True),
 ScalarEvent(anchor=None, tag=None, implicit=(True, False), value='steps'),
 SequenceStartEvent(anchor=None, tag=None, implicit=True),
 # REVIEW - entry of steps is a list of actv-obj
 MappingStartEvent(anchor=None, tag=None, implicit=True),
 # REVIEW - entry of steps or single actv-obj must map to sequence structure actv -> to -> sig -> data -> ptype
