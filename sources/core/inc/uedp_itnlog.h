 ...
 */
  ...
  /** ANCHOR - Định nghĩa các mức độ log
  ...
  /** ANCHOR - Ghi chú các hàm chức năng của internal logger
   * 1 ham init
   * 1 ham log <-> push
   * 1 ham clear <-> pop
  ...
  /** ANCHOR - Xóa một log entry khỏi internal logger và trả về log entry đã xóa
  ...
  /** ANCHOR - Dump tất cả log entry hiện có trong internal logger
  ...
  /** ANCHOR - Lấy số lượng log entry hiện có trong internal logger
  ...
  */
  ...
  /** ANCHOR - Đặt mức độ log cho internal logger
  ...
  /** ANCHOR - Lấy mức độ log hiện tại của internal logger
  ...
  /** ANCHOR - Lấy bộ lọc log hiện tại của internal logger
  ...
  /** ANCHOR - Đặt hàm đầu ra cho internal logger
