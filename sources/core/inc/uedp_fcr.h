 ...
 * @file uedp_fcr.h
 * @author Hai Minh
 * @brief Fatal Code Return (FCR) - Declaration for error codes and handling in UEDP core
 * @version 0.1
 * @date 2026-08-01
 ...
 */
  ...
  /** ANCHOR - Macro tiện lợi để ghép mã MODULE và SUB-CODE thành 1 uedp_fcr_code_t
  ...
  /** ANCHOR - Macro tiện lợi để gọi uedp_fcr_raise() với thông tin file/line tự động điền
   */
