 ...
 */
...
#ifndef __ESP32_WR32_ARCH_H__
  #define __ESP32_WR32_ARCH_H__
  ...
  /**
   * @brief Khởi tạo môi trường làm việc trên ESP32-WR32 cho Core hoạt động
   */
